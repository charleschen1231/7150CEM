...
三分类后：
最佳参数： {'alpha': 0.5}
最佳得分： 0.8371527777777779
准确率： 0.8298611111111112
F1 Macro： 0.32351709395365785
F1 Micro： 0.8298611111111112
F1 Weighted： 0.7556767033044365
'''
# 加载数据集
...
plt.xticks(range(len(params)), [str(param['alpha']) for param in params], rotation='vertical')
...
# 使用最佳参数构建朴素贝叶斯模型
best_nb_classifier = MultinomialNB(**grid_search.best_params_)
